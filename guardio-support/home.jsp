...
<head>
    ...
    <meta name="description" content="Guardio Online Support System">
    <link rel="icon" type="image/x-icon" href="img/favicon.ico">

    <title>Guardio Support Portal</title>
            ...
            <a class="header item" href="home.jsp">
                <div class="product-title" style="margin-top: 0px;">
                    ...
                    <h1 class="product-title-text" style="margin-top: 0px;">
                        Guardio<span class="portal-name"> Support Portal</span>
                    </h1>
                </div>
            </a>
                    ...
                    <div class="three wide column">
                        <div class="side-panel-wrapper">
                            <div class="ui secondary vertical menu">
                                <a class="active item">
                                    <i class="icon home"></i> Workspace
                                </a>
                                <a class="item">
                                    <i class="icon briefcase"></i> Projects
                                </a>
                                <a class="item">
                                    <i class="icon tasks"></i> Incidents
                                </a>
                                <a class="item">
                                    <i class="icon handshake"></i> Opportunities
                                </a>
                                <a class="item">
                                    <i class="icon grab"></i> Defects
                                </a>
                                <a class="item">
                                    <i class="icon dashboard"></i> Dashboards
                                </a>
                                <a class="item">
                                    <i class="icon repeat"></i> Recents
                                </a>
                                <a class="item">
                        ...
                        <div class="ui equal width left aligned padded grid stackable">
                            <div class="row no-top-padding">
                                <div class="column">
                                    <div class="ui segments no-padding">
                                        <div class="ui segment basic no-padding-bottom widget-header">
                                            <h4 style="margin:0" class="ui left floated header">
                                                Ticket Count statistics
                                            </h4>
                                            <div class="clearfix"></div>
                                        </div>
                                        <div class="ui basic segment no-padding">
                                            <div class="ticket-stats-chart">
		                                        <canvas id="ticket-stats-chart" width="400" height="100"></canvas>
	                                        </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="sixteen wide tablet four wide computer column">
                                    <div class="ui segment left aligned teal inverted">
                                        <div class="ui  statistic">
                                            <div class="value counter text-left text-white">143</div>
                                            <div class="label text-white">
                                                Ticket Count for May
                                            </div>
                                        </div>
                                        <div id="flot-order" class="flotchart" style="padding: 0px; position: relative;"><canvas class="flot-base" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 246px; height: 100px;" width="492" height="200"></canvas><canvas class="flot-overlay" width="492" height="200" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 246px; height: 100px;"></canvas></div>
                                    </div>
                                </div>
                                <div class="sixteen wide tablet four wide computer column">
                                    <div class="ui segment left aligned purple inverted">
                                        <div class="ui statistic">
                                            <div class="value text-left text-white">
                                                <span class="counter">87.6</span> %
                                            </div>
                                            <div class="label text-white">
                                                On-time clearence rate
                                            </div>
                                        </div>
                                        <div id="flot-avarage" class="flotchart" style="padding: 0px; position: relative;"><canvas class="flot-base" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 246px; height: 100px;" width="492" height="200"></canvas><canvas class="flot-overlay" width="492" height="200" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 246px; height: 100px;"></canvas></div>
                                    </div>
                                </div>
                                <div class="sixteen wide tablet four wide computer column">
                                    <div class="ui segment left aligned blue inverted">
                                        <div class="ui  statistic">
                                            <div class="value counter text-left text-white">12</div>
                                            <div class="label text-white">
                                                Waiting on Guardio
                                            </div>
                                        </div>
                                        <div id="flot-saves" class="flotchart" style="padding: 0px; position: relative;"><canvas class="flot-base" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 246px; height: 100px;" width="492" height="200"></canvas><canvas class="flot-overlay" width="492" height="200" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 246px; height: 100px;"></canvas></div>
                                    </div>
                                </div>
                                <div class="sixteen wide tablet four wide computer column">
                                    <div class="ui segment left aligned violet inverted">
                                        <div class="ui  statistic">
                                            <div class="value counter text-left text-white">47</div>
                                            <div class="label text-white">
                                                Waiting on Customer
                                            </div>
                                        </div>
                                        <div id="flot-view" class="flotchart" style="padding: 0px; position: relative;"><canvas class="flot-base" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 246px; height: 100px;" width="492" height="200"></canvas><canvas class="flot-overlay" width="492" height="200" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 246px; height: 100px;"></canvas></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="stretched row">
                                ...
                                <div class="sixteen wide tablet ten wide computer column">
                                    <div class="ui segments">
                                        <div class="ui segment no-padding-bottom widget-header">
                                        ...
                                        <div class="ui segment left aligned">
                                            ...
                                            <table class="ui very basic center aligned  celled table text-left">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>Ticket ID</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>#KD0238023</td>
                                                        <td>10 April 2020</td>
                                                        <td class="text-center"><i class="green check icon"></i></td>
                                                        <td><a class="ui blue mini basic label">Waiting on Guardio</a></td>
                                                    </tr>
                                                    <tr>
                                                        <td>2</td>
                                                        <td>#IS0238672</td>
                                                        <td>2 May 2020</td>
                                                        <td class="text-center"><i class="green check icon"></i></td>
                                                        <td><a class="ui green mini basic label">Waiting on Customer</a></td>
                                                    </tr>
                                                    <tr>
                                                        <td>3</td>
                                                        <td>#PE1237871</td>
                                                        <td>13 May 2020</td>
                                                        <td class="text-center"><i class="green check icon"></i></td>
                                                        <td><a class="ui purple mini basic label">In Progress</a></td>
                                                    </tr>
                                                    <tr>
                                                        <td>4</td>
                                                        <td>#YY1230920</td>
                                                        <td>18 May 2020</td>
                                                        <td class="text-center"><i class="green check icon"></i></td>
                                                        <td><a class="ui red mini basic label">Not Started</a></td>
                                                    </tr>
                                                    <tr>
                                                        <td>5</td>
                                                        <td>#PS1230493</td>
                                ...
                                <div class="sixteen wide tablet six wide computer column">
                                    <div class="ui segments">
                                        ...
                                        <div class="ui segment left aligned">
                                            <canvas id="current-cliam-state" width="200" height="150"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
