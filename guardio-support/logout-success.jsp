...
<head>
    ...
    <meta name="description" content="Guardio Support | Logout Success">

    <title>Guardio Support | Logout Success</title>
    ...
    <main class="center-segment">
        <div class="ui container medium center aligned middle aligned">
            <div class="ui segment login-card">
                <img class="ui centered small rounded image" src="./img/guardio-logo.svg" />
