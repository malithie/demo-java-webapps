...
<%
    ...
    if (currentSession == null || currentSession.getAttribute("authenticated") == null) {
        ...
        response.sendRedirect("index.jsp?theme=" + theme);
        return;
    }
...
<head>
    ...
    <meta name="description" content="Guardio Billing | Manage and maintain your bills & invoices">
    <link rel="icon" type="image/x-icon" href="img/favicon.ico">

    <title>Guardio Billing | Manage and maintain your bills & invoices</title>
...
<body class="app-home dispatch">
    <div id="actionContainer">
        <nav class="ui borderless top fixed app-header menu  <%= isInverted ? "inverted" : "" %>">
                ...
                <a class="header item" href="home.jsp">
                    <div class="product-title" style="margin-top: 0px;">
                        ...
                        <h1 class="product-title-text" style="margin-top: 0px;">
                            Guardio<span class="portal-name"> Billing</span>
                        </h1>
                    </div>
                </a>
                ...
                <div class="right menu">
                    <div role="listbox" aria-expanded="false" class="ui floating item dropdown user-dropdown">
                        ...
                        <div class="menu" aria-labelledby="navbarDropdownMenuLink">
                            <div class="ui unstackable items authenticated-user">
                                <div class="item header">
                                    <div class="ui circular image user-image tiny user-avatar">
                                        <div class="wrapper">
                                            <img alt="avatar" src="https://www.gravatar.com/avatar/422ec35ee753b1a54c54f45ce5a34caf">
                                        </div>
                                    </div>
                                    <div class="middle aligned content">
                                        <div class="description">
                                            <div class="name">Brion Silva</div>
                                            <div class="email">brion@wso2.com</div>
                                            <div class="ui hidden divider"></div>
                                            <a class="ui tiny primary button" role="button" href="/user-portal/personal-info">Personal Info</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <main role="main" class="main-content">
            <div class="ui container fluid dashboard-content">
                <div class="ui grid">
                    <div class="row">
                        <div class="three wide column">
                            <div class="side-panel-wrapper">
                                <div class="ui secondary vertical menu">
                                    ...
                                    <a class="item">
                                        <i class="history icon"></i> Payment History
                                    </a>
                                    <a class="item">
                                        <i class="credit card outline icon"></i> Payment methods
                                    </a>
                                    <a class="item">
                                        <i class="icon chart line"></i> Billing Reports
                                    </a>
                                    <a class="item">
                                ...
                                <div class="ui grid">
                                    <div class="row">
                                        <div class="sixteen wide column">
                                            <div class="ui segments">
                                                <div class="ui segment widget-header">
                                                    <h3 class="ui header segment-header no-top-bottom-margin">Plan Details</h3>
                                                </div>
                                                        ...
                                                        <div class="ui two column grid">
                                                            <div class="four wide column">
                                                                <div class="padding text-align-center">
                                                                    <h1>Smart Life</h1>
                                                                    <i class="heartbeat circular blue icon huge"></i>
                                                                    <div class="ui hidden divider"></div>
                                                                    <p>You are currently entitled to the <strong>Smart Life</strong> plan
                                                                        with
                                                                        <strong>monthly billing</strong> </p>
                                                                </div>
                                                            </div>
                                                            <div class="twelve wide column">
                                                                <table class="ui very basic padding table">
                                                                    <thead>
                                                                        <tr>
                                                                            <th>Billing Description</th>
                                                                            <th class="right aligned collapsing">Charged Amount</th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>Hopitalizations Cover</td>
                                                                            <td>$130</td>
                                                                        </tr>
                                                                        <tr>
                                    ...
                                    <div class="row">
                                        <div class="six wide column">
                                            <div class="ui segments">
                                                <div class="ui segment widget-header">
                                                    <h3 class="ui header segment-header no-top-bottom-margin">Invoices</h3>
                                                </div>
                                                <div class="ui segment widget">
                                                    <div class="ui invoices middle aligned relaxed divided list">
                                                        <div class="item">
                                        ...
                                        <div class="five wide column">
                                            <div class="ui segments">
                                                <div class="ui segment widget-header">
                                                    <h3 class="ui header segment-header no-top-bottom-margin">Payment Method</h3>
                                                </div>
                                                <div class="ui segment widget">
                                                    <div class="payment-method">
                                                        <a class="ui red ribbon label">Primary</a>
                                                        <h2 class="card-holder"><%=name%></h2>
                                                        <h2 class="card-number">XXXX XXXX XXXX 4592</h2>
                                                        <div>
                                                            <span>Good Thru</span>
                                                            <h2 class="no-margin">09/21</h2>
                                                        </div>
                                                        <img class="ui small image" src="./img/card.png">
                                                    </div>
                                                    <div class="ui clearing hidden divider"></div>
                                                    <div class="payment-method">
                                                        <h2 class="card-holder"><%=name%></h2>
                                                        <h2 class="card-number">XXXX XXXX XXXX 6091</h2>
                                                        <div>
                                                            <span>Good Thru</span>
                                                            <h2 class="no-margin">06/20</h2>
                                                        </div>
                                                        <img class="ui small image" src="./img/card.png">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="five wide column">
                                            <div class="ui segment inverted fill-primary">
                                                <h4 class="ui header segment-header">Due Date</h4>
                                                <h1 class="ui header segment-header renewal">26th June 2020</h1>
                                            </div>
                                            <div class="ui segment inverted fill-secondary">
                                                <h4 class="ui header segment-header">Balance carried forward</h4>
                                                <h1 class="ui header segment-header renewal">$120.56</h1>
                                            </div>
                                            <div class="ui segment inverted fill-tertiary">
                                                <h4 class="ui header segment-header">Next Renewal</h4>
                                                <h1 class="ui header segment-header renewal">25th August 2021</h1>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div id="app-footer" class="ui borderless bottom fixed app-footer menu <%= isInverted ? "inverted" : "" %>">
            <div class="item copyright"><p>Guardio Insurance &copy;
    ...
    <script>
        var monthctx = document.getElementById('monthly-claims').getContext('2d');
        var claimctx = document.getElementById('current-cliam-state').getContext('2d');
        var radarctx = document.getElementById('cliam-state').getContext('2d');

        var config = {
            type: 'horizontalBar',
            data: {
                labels: ["Maturity Claims", "Death Claims", "Hospitalizations", "Medical Emergencies", "Accidents"],
                datasets: [
                    {
                        label: "Claims Count",
        ...
        var claimconfig = {
            ...
            data: {
                ...
                datasets: [{
                    data: [1531, 137, 2695, 44, 1612, 1261, 611, 394, 938, 1290],
                    label: "Amount in USD",
                    borderColor: "#3e95cd",
        ...
        var myChart = new Chart(monthctx, claimconfig);
        var myChart = new Chart(claimctx, config);
        var myChart = new Chart(radarctx, radar);
    </script>
</body>
</html>
