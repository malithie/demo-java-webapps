...
<head>
    ...
    <meta name="description" content="Guardio Life | Logout Success">

    <title>Guardio Partner | Logout Success</title>
    ...
    <main class="center-segment">
        <div class="ui container medium center aligned middle aligned">
            <div class="ui segment login-card">
                <img class="ui centered small rounded image" src="./img/guardio-partner-logo-mini.svg" />
