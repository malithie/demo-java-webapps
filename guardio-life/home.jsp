...
<head>
    ...
    <meta name="description" content="Guardio Life - The right protection for you and your family.">
    <link rel="icon" type="image/x-icon" href="img/favicon.ico">

    <title>Guardio Life</title>
...
<div id="actionContainer">
            ...
            <a class="header item" href="home.jsp">
                <div class="product-title" style="margin-top: 0px;">
                    ...
                    <h1 class="product-title-text" style="margin-top: 0px;">
                        Guardio<span class="portal-name"> Life</span>
                    </h1>
                </div>
            </a>
            ...
            <div class="right menu">
                <div role="listbox" aria-expanded="false" class="ui floating item dropdown user-dropdown">
                    ...
                    <div class="dropdown-menu menu transition visible" aria-labelledby="navbarDropdownMenuLink">
                            <a class="item" target="_blank" href="<%=properties.getProperty("userPortalURL")%>">
                                My Account
                            </a>
                            <a class="item" target="_blank" href="<%=properties.getProperty("billingPortalURL")%>">
                                Billing
                            </a>
                    ...
                    <div class="three wide column">
                        <div class="side-panel-wrapper">
                            <div class="ui secondary vertical pointing menu">
                                ...
                                <a class="item">
                                    <i class="icon tasks"></i> Add Claim
                                </a>
                                <a class="item">
                                    <i class="icon mail"></i> Messages
                                </a>
                                <a class="item">
                                    <i class="icon paper plane"></i> Notifications
                                </a>
                                <a class="item">
                                    <i class="cogs icon"></i> Settings
                                </a>
                                <a class="item">
                                    <i class="icon chart line"></i> Reports
                                </a>
                                <a class="item">
                                ...
                                <div class="four column row">
                                    <div class="right floated column">
                                        <div class="ui compact menu floated right">
                                            ...
                                            <a class="item">
                                                <i class="icon users"></i> Notifictions
                            ...
                            <div class="row">
                                <section class="jumbotron">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h1 class="jumbotron-heading">The Right Protection for you and your family.</h1>
                                                <p>
                                                    Excellence in Life Insurance since 2001. We are Sri Lanka's leading life insurers. Choose Your Life with Sri Lanka's Best Health Insurance Company.
                                                </p>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="jumbotron-illustration float-right">
                                                    <img src="img/family-illustration.svg" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="five wide column">
                                    <div class="ui segment" style="height:100%;">
                                        <h4 class="ui header segment-header">Current Allocated Budget ( USD )</h4>
                                ...
                                <div class="three wide column">
                                    <div class="ui segment" style="height:100%;">
                                        <h4 class="ui header segment-header">Current Claim States</h4>
                                        <canvas id="current-cliam-state" width="400" height="500"></canvas>
                                    </div>
                                </div>
                                <div class="eight wide column">
                                    <div class="ui segment" style="height:100%;">
                                        <h4 class="ui header segment-header">Average Monthly claims</h4>
                                        <canvas id="monthly-claims" width="400" height="160"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div id="app-footer" class="ui borderless bottom fixed app-footer menu inverted">
        <div class="item copyright"><p>Guardio Life &copy;
    ...
    <script>
        ...
        var claimconfig = {
            ...
            data: {
                ...
                datasets: [{
                    data: [2000, 100, 150, 1200, 1900, 0, 900, 580, 2400, 1400],
                    label: "Amount in USD",
                    borderColor: "#3e95cd",
                    fill: false
                }]
